...
<div class="soubg">
	<div class="sou">
        ...
        <c:if test="${sessionScope.easybuyUserLogin==null}">
        	<span class="fl">你好，请<a href="${ctx }/Login.html">登录</a>&nbsp; <a href="${ctx }/pre/Regist" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;</span>
        </c:if>
        <!-- 获取登陆用户昵称 -->
        <c:if test="${sessionScope.easybuyUserLogin!=null}">
            <span class="fl"><a href="${ctx }/pre/user/index" style="color: red;font-weight: bolder;">${sessionScope.easybuyUserLogin.userName}</a>&nbsp;|&nbsp;<a href="${ctx }/order/index?userId=${sessionScope.easybuyUserLogin.id}">我的订单</a>&nbsp;</span>
          </c:if>
          <!-- 管理员登陆显示 -->
          <c:if test="${sessionScope.easybuyUserLogin!=null && sessionScope.easybuyUserLogin.type==1}">
            <span class="fl">|&nbsp;<a href="${ctx }/pro/index">后台管理</a>&nbsp;</span>
          </c:if>
          <!-- 登陆成功出现注销功能！没登录没有。。 -->
          <c:if test="${sessionScope.easybuyUserLogin!=null}">
             <span class="fl">|&nbsp;<a href="${ctx }/remove">注销</a>&nbsp;</span>
          </c:if>
        	...
        	<span class="ss">
            	<div class="ss_list">
                    ...
                    <div class="ss_list_bg">
                        ...
                        <div class="ss_list_c">
                        	<ul>
                            	<li><a href="${ctx}/ProductServlet?action=queryProductList4">收藏的宝贝</a></li>
