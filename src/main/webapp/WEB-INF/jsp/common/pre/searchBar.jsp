...
<div class="top">
    <div class="logo">
        <a href="${ctx }/index"><img src="${ctx}/statics/images/logo.png"></a>
    </div>
    <div class="search">
        <form action="${ctx}/ProductServlet?action=queryLikeProductList" method="post">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            ...
            <c:if test="${sessionScope.easybuyUserLogin==null}">
                <div class="un_login">还未登录！<a href="${ctx }/Login.html" style="color:#ff4e00;">马上登录</a></div>
            </c:if>
            <c:if test="${sessionScope.easybuyUserLogin!=null}">
            ...
            <ul class="cars">
                <c:forEach items="${sessionScope.cart.items}" var="temp">
                    <li>
                        <div class="img"><a href="${ctx}/pro/${temp.product.id}"><img src="${ctx}/files/${temp.product.fileName}" width="58" height="58" /></a></div>
                        <div class="name"><a href="${ctx}/pro/${temp.product.id}">${temp.product.name}</a></div>
            ...
            <c:if test="${sessionScope.easybuyUserLogin==null}">
                <div class="price_a"><a href="${ctx }/Login.html">去登录</a></div>
            </c:if>
            <c:if test="${sessionScope.easybuyUserLogin!=null}">
