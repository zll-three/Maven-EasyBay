<%@page import="com.entity.EasybuyProductCategory"%>
<%@page import="com.entity.EasybuyProduct"%>
...
<title>易买网</title>
	...
	<c:redirect url="${request.getContextPath()}/Login.html"></c:redirect>
	</c:if>
</head>
	...
	<div class="i_bg bg_color">
		...
		<div class="m_content">
			...
			<div class="m_right" id="content" style="font-weight: bolder;">
				...
				<br>
				<form action="${ctx }/pro/getImgs" method="post"
					id="productAdd" enctype="multipart/form-data">
					<table border="0" class="add_tab" style="width: 930px;"
						...
						<tr>
							<input type="hidden" name="id" value="${easybuyProduct.id}"	id="id">
						...
						<tr>
							...
							<td><c:if test="${easybuyProduct.id != 0}">
									<img src="${ctx}/files/${easybuyProduct.fileName}" width="50"
										height="50" id="img" />
