        ...
        <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td style="padding:20px 0 30px 0; font-family:'宋体';">
                    收款人信息：全称 ${sessionScope.easybuyUserLogin.userName} ；地址 ${currentOrder.userAddress} ； <br/>
                </td>
            </tr>
            <tr>
                <td>
                    <a href="${ctx}/IndexServlet?action=index">首页</a> &nbsp; &nbsp; <a href="${ctx}/EasybuyUserServlet?action=index">用户中心</a>
                </td>
            </tr>
        </table>
    </div>
